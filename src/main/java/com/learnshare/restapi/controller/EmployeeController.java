package com.learnshare.restapi.controller;

import java.util.List;

import com.learnshare.restapi.model.Employee;
import com.learnshare.restapi.service.EmployeeService;
import com.learnshare.restapi.util.RESTAPIError;
...
public class EmployeeController {
	...
	public ResponseEntity<?> getEmployee(@PathVariable("id") long id) {
		...
		if (employee == null) {
			...
			return new ResponseEntity(new RESTAPIError("Employee with id " + id
	...
	public ResponseEntity<?> createEmployee(@RequestBody Employee employee, UriComponentsBuilder ucBuilder) {
		...
		if (employeeService.isEmployeeExist(employee)) {
			...
			return new ResponseEntity(new RESTAPIError("Unable to create. A Employee with name " +
	...
	public ResponseEntity<?> updateEmployee(@PathVariable("id") long id, @RequestBody Employee employee) {
		...
		if (currentEmployee == null) {
			...
			return new ResponseEntity(new RESTAPIError("Unable to upate. Employee with id " + id + " not found."),
	...
	public ResponseEntity<?> deleteEmployee(@PathVariable("id") long id) {
		...
		if (employee == null) {
			...
			return new ResponseEntity(new RESTAPIError("Unable to delete. Employee with id " + id + " not found."),
					HttpStatus.NOT_FOUND);
		}
